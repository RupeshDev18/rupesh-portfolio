...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-24 px-4 sm:px-6 bg-gradient-to-b from-slate-50 via-indigo-50/10 to-slate-50 dark:from-slate-950 dark:via-blue-950/15 dark:to-slate-950 text-slate-800 dark:text-slate-100 relative overflow-hidden transition-colors duration-300">
      {/* Ambient Radial Lights */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-indigo-500/10 dark:bg-sky-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-4">
            Work <span className="bg-gradient-to-r from-indigo-600 via-sky-600 to-emerald-600 dark:from-indigo-400 dark:via-sky-400 dark:to-emerald-400 bg-clip-text text-transparent">Experience</span>
          </h2>
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute left-1/2 top-4 bottom-4 w-1 -translate-x-1/2 bg-gradient-to-b from-indigo-500 via-sky-500 to-indigo-600 dark:from-indigo-400 dark:via-sky-400 dark:to-emerald-400 rounded-full shadow-[0_0_12px_rgba(99,102,241,0.3)]" />

          {/* Left Vertical Line (Mobile Fallback) */}
          <div className="md:hidden absolute left-5 top-4 bottom-4 w-1 bg-gradient-to-b from-indigo-500 to-sky-500 rounded-full" />
              ...
              return (
                <div key={idx} className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="absolute left-5 md:left-1/2 -translate-x-1/2 top-6 md:top-1/2 md:-translate-y-1/2 z-20">
                    <div className="w-9 h-9 rounded-full bg-white dark:bg-slate-900 border-4 border-indigo-500 dark:border-sky-400 flex items-center justify-center shadow-lg shadow-indigo-500/30 dark:shadow-sky-400/40">
                      <div className="w-2.5 h-2.5 rounded-full bg-indigo-500 dark:bg-sky-400 animate-pulse" />
                    </div>
                  </div>
                    ...
                    {isEven ? (
                      ...
                      >
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                          ...
                          <span className="md:hidden inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/20 text-xs font-semibold">
                            <FiCalendar className="w-3 h-3" /> {exp.period}
                          </span>
                        </div>

                        <div className="flex flex-wrap items-center gap-3 text-sm font-semibold text-indigo-600 dark:text-sky-400 mb-4">
                          <span className="flex items-center gap-1">
                            <FiBriefcase className="w-4 h-4 text-indigo-500" /> {exp.company}
                          </span>
                          {exp.location && (
                        ...
                        <ul className="space-y-2.5 text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-6">
                          {exp.highlights?.map((point, i) => (
                            <li key={i} className="flex items-start gap-2">
                              <FiCheckCircle className="w-4 h-4 text-indigo-500 shrink-0 mt-0.5" />
                              <span>{point}</span>
                            </li>
                          ))}
                        </ul>
                      ...
                      >
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/80 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 text-indigo-600 dark:text-sky-400 font-bold text-sm shadow-sm">
