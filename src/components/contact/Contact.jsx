        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 flex flex-col justify-start gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">Let's Talk</h3>
              ...
              {contactInfo.map((info, idx) => (
                ...
                >
                  ...
                  <div className="text-left">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white group-hover:text-teal-600 dark:group-hover:text-cyan-400 transition-colors">{info.title}</h3>
                    <p className="text-gray-600 dark:text-gray-400 font-medium">{info.info}</p>
                  </div>
                </motion.a>
              ))}
            </div>
